...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayUserFolder = function displayUserFolder(data) {
	  ...
	  $('.rename-folder-button').on('click', function () {
	    ...
	    api.renameFolder(data, folderId).done($(this).prevAll('h5:last').text(newName)).fail(ui.onError);
	  });
	};

	var displayUserFile = function displayUserFile(data) {
	  console.log(data);
	  var userFileTemplate = __webpack_require__(28);
	  ...
	  $('.rename-button').on('click', function () {
	    ...
	    api.renameFile(data, fileId).done($(this).prevAll('h5:last').text(newName)).fail(ui.onError);
	  });
	  $('.delete-button').on('click', function () {
	    var fileId = $(this).data('file-id');
	    console.log(fileId);
	    api.deleteFile(fileId).done($(this).parent().remove()).fail(ui.onError);
	  });
	};
	...
	var displayOtherUserFolder = function displayOtherUserFolder(data) {
	  console.log(data);
	  var otherUserFolderTemplate = __webpack_require__(29);
	...
	var displayOtherUserFile = function displayOtherUserFile(data) {
	  console.log(data);
	  var otherUserFileTemplate = __webpack_require__(30);
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  event.preventDefault();
	  api.signIn(data).done(getRootFolder).done(onGetUsers).fail(ui.failure);
	  $('#sign-in').modal('hide');
	...
	var onCreateFolder = function onCreateFolder(event) {
	  event.preventDefault();
	  var folderData = getFormFields(this);
	  ...
	  api.createFolder(data).done(ui.createSuccess).fail(ui.onError);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#multipart-form-data').on('submit', function (event) {
	    ...
	    return $.ajax({
	      ...
	      return $('.upload').html('' + data.file.url);
	    }).fail(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showFolders = function showFolders(data) {
	...
	var getMyFolders = function getMyFolders() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"col-xs-4 col-sm-2 folder-info\" data-path=\""
	    ...
	    + "\">\n  <img class=\"icon\" src=\"icon-folder.png\" >\n  <h5>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"col-xs-4 col-sm-2 folder-info\">\n  <img class=\"icon\" src=\"icon-file.png\" data-url=\""
