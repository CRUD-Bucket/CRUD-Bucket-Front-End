...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayOtherUserFolder = function displayOtherUserFolder(data) {
	  console.log(data);
	  var otherUserFolderTemplate = __webpack_require__(31);
	...
	var displayOtherUserFile = function displayOtherUserFile(data) {
	  console.log(data);
	  var otherUserFileTemplate = __webpack_require__(32);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#multipart-form-data').on('submit', function (event) {
	    ...
	    return $.ajax({
	      ...
	      contentType: false,
	      data: data
	    }).done(addOneFile).done($('#upload-file').modal('hide')).fail(function (err) {
